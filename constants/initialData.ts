import { Post, Course, Podcast, PrayerRequest, Community, SabbathSchoolLesson, Comment, BibleVerse, Notification } from '../types';
...
export const initialPosts: Post[] = [
  {
    ...
    comments: [
      {
        id: 'comment_1',
        content: 'በጣም ደስ የሚል ስብከት ነው። እግዚአብሔር ይባርክህ።',
        author: 'User One',
        author_id: 'user_1',
        likes: ['user_2'],
        replies: [],
...
export const initialPodcasts: Podcast[] = [
  {
    ...
    comments: [
      {
        id: 'podcast_comment_1',
        content: 'በጣም ጣፋጭ ዝማሬ ነው',
        author: 'User Two',
        author_id: 'user_2',
        likes: [],
        replies: [],
  ...
  },
  {
    ...
    thumbnailUrl: 'https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?w=400&h=225&fit=crop',
    author: 'Pastor Abraham Tessema',
    author_id: 'super_admin_1',
    plays: 89,
    likes: ['user_4', 'user_6'],
...
export const initialPrayerRequests: PrayerRequest[] = [
  ...
  },
  {
    ...
    description: 'I have an important life decision to make and need God\'s guidance.',
    author: 'Anonymous',
    author_id: 'user_2',
    isAnonymous: true,
    prayers_count: 8,
...
export const initialNotifications: Notification[] = [
  ...
  },
  {
    ...
    content: 'A new Bible study course has been added to the learning platform.',
    type: 'course',
    recipient_id: 'user_1',
