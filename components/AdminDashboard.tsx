...
interface AdminDashboardProps {
  ...
  deleteContent: (
    contentId: string,
    type: "post" | "podcast" | "course" | "prayer"
  ) => void;
  postForm: any;
...
export function AdminDashboard({
  ...
  const [analytics, setAnalytics] = useState({
    ...
    totalPlays: podcasts.reduce(
      (sum, podcast) => sum + Number(podcast.plays || 0),
      0
    ),
    engagementRate: 75,
    growthRate: 12,
  ...
  useEffect(() => {
    setAnalytics({
      ...
      totalPlays: podcasts.reduce(
        (sum, podcast) => sum + (podcast.plays || 0),
        0
      ),
      engagementRate: 75,
      growthRate: 12,
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `kebena-sda-church-data-${
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-slate-800 text-white sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="flex items-center space-x-2 lg:space-x-3">
                <Badge
                  variant="secondary"
                  className="bg-red-500 text-white hidden sm:flex"
                >
          ...
          {/* Mobile menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden border-t border-slate-600 py-4">
      ...
      <div className="flex">
        ...
        <div
          ...
          } lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-40 w-64 bg-slate-700 min-h-screen text-white transition-transform duration-300 ease-in-out lg:transition-none`}
        >
          <div className="p-4">
            {/* Mobile close button */}
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <Badge variant="secondary">
                  {posts.length + podcasts.length + courses.length}
                </Badge>
              </button>
                ...
                <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <Eye className="h-6 w-6 lg:h-8 lg:w-8 text-green-200" />
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-purple-200 mt-1">
                          ...
                          {language === "am" ? "ተሳትፎ" : "engagement"}
                        </p>
                      </div>
                      <Users className="h-6 w-6 lg:h-8 lg:w-8 text-purple-200" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
                  <CardContent className="p-4 lg:p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <Heart className="h-6 w-6 lg:h-8 lg:w-8 text-orange-200" />
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2 text-lg lg:text-xl">
                      ...
                      <span>
                        {language === "am" ? "የቅርብ ጊዜ ይዘት" : "Recent Content"}
                      </span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between sm:justify-end space-x-3">
                              ...
                              <Button
                                ...
                                variant="ghost"
                                onClick={() =>
                                  deleteContent(item.id, item.contentType)
                                }
                              >
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2 text-lg lg:text-xl">
                      ...
                      <span>
                        {language === "am" ? "የቁልፍ መመዘኛዎች" : "Key Metrics"}
                      </span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      <div>
                        <div className="flex justify-between text-sm mb-2">
                          <span>
                            {language === "am" ? "የሳምንት እድገት" : "Weekly Growth"}
                          </span>
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-4">
                        <div className="text-center p-3 bg-blue-50 rounded-lg">
                          ...
                          <p className="text-xs text-blue-600">
                            {language === "am" ? "ጠቅላላ ወደድኩ" : "Total Likes"}
                          </p>
                        </div>
                        <div className="text-center p-3 bg-green-50 rounded-lg">
                          ...
                          <p className="text-xs text-green-600">
                            {language === "am" ? "ጠቅላላ ማጫወት" : "Total Plays"}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <form onSubmit={createPost} className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              >
                                ...
                                <option value="event">
                                  {language === "am" ? "ዝግጅት" : "Event"}
                                </option>
                                <option value="teaching">
                                  {language === "am" ? "Learning" : "Teaching"}
                                </option>
                                <option value="devotional">
                                  {language === "am" ? "የጸሎት ጊዜ" : "Devotional"}
                                </option>
                              </select>
                            </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              <Label>
                                {language === "am" ? "ሽፋን ምስል" : "Cover Image"}
                              </Label>
                            ...
                            <div>
                              ...
                              <div className="mt-1 space-y-2">
                                <div className="flex items-center space-x-2">
                                  <input
                                    type="radio"
                                    id="post-source-upload"
                                    name="post-source"
                                    value="upload"
                                    checked={postForm.sourceType === "upload"}
                                    onChange={() =>
                                      setPostForm({
                                        ...postForm,
                                        sourceType: "upload",
                                  ...
                                  />
                                  <Label htmlFor="post-source-upload">
                                    {language === "am"
                                      ? "ፋይል ጫን"
                                      : "File Upload"}
                                  </Label>
                                ...
                                <div className="flex items-center space-x-2">
                                  <input
                                    ...
                                    name="post-source"
                                    value="link"
                                    checked={postForm.sourceType === "link"}
                                    onChange={() =>
                                      setPostForm({
                                        ...postForm,
                                        sourceType: "link",
                                  ...
                                  />
                                  <Label htmlFor="post-source-link">
                                    {language === "am" ? "ሊንክ" : "Link"}
                                  </Label>
                                </div>
                              </div>

                              {/* File Upload or Link Input based on selection */}
                              {postForm.sourceType === "upload" ? (
                                <div className="mt-2">
                                  <Input
                                    type="file"
                                    ...
                                    className="w-full"
                                  />
                                  {postForm.contentFile && (
                                    <p className="text-sm text-gray-500 mt-1">
                                      {postForm.contentFile.name}
                                    </p>
                                  )}
                                </div>
                              ) : (
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-4 pt-6 border-t">
                          <Button
                            type="button"
                            variant="destructive"
                            onClick={() =>
                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                placeholder={
                                  language === "am"
                                    ? "ለምሳሌ፣ 25 ደቂቃ፣ 1 ሰዓት 15 ደቂቃ"
                                    : "e.g., 25 min, 1 hour 15 min"
                                }
                                required
                                className="mt-1"
                              />
                            ...
                            <div>
                              ...
                              <div className="mt-1 space-y-2">
                                <div className="flex items-center space-x-2">
                                  <input
                                    type="radio"
                                    id="podcast-source-upload"
                                    name="podcast-source"
                                    value="upload"
                                    checked={
                                      podcastForm.sourceType === "upload"
                                    }
                                    onChange={() =>
                                      setPodcastForm({
                                        ...podcastForm,
                                  ...
                                  />
                                  <Label htmlFor="podcast-source-upload">
                                    {language === "am"
                                      ? "ፋይል ጫን"
                                      : "File Upload"}
                                  </Label>
                                ...
                                <div className="flex items-center space-x-2">
                                  <input
                                    type="radio"
                                    id="podcast-source-link"
                                    name="podcast-source"
                                    value="link"
                                    checked={podcastForm.sourceType === "link"}
                                    onChange={() =>
                                      setPodcastForm({
                                        ...podcastForm,
                                        sourceType: "link",
                                  ...
                                  />
                                  <Label htmlFor="podcast-source-link">
                                    {language === "am" ? "ሊንክ" : "Link"}
                                  </Label>
                                </div>
                              </div>
                            ...
                            <div>
                              ...
                              <div className="mt-1 space-y-2">
                                <div className="flex items-center space-x-2">
                                  <input
                                    type="radio"
                                    id="course-materials-upload"
                                    name="course-materials"
                                    value="upload"
                                    checked={
                                      courseForm.materialsType === "upload"
                                    }
                                    onChange={() =>
                                      setCourseForm({
                                        ...courseForm,
                                        materialsType: "upload",
                                      })
                                    }
                                  />
                                  <Label htmlFor="course-materials-upload">
                                    {language === "am"
                                      ? "ፋይል ጫን"
                                      : "File Upload"}
                                  </Label>
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  />
                                  <Label htmlFor="course-materials-link">
                                    {language === "am" ? "ሊንክ" : "Link"}
                                  </Label>
                                </div>
                              </div>
                              ...
                              {courseForm.materialsType === "upload" ? (
                                <div className="mt-2">
                                  <Input
                                    ...
                                    className="w-full"
                                  />
                                  {courseForm.materialsFiles &&
                                    courseForm.materialsFiles.length > 0 && (
                                      <div className="mt-2 space-y-1">
                                        {courseForm.materialsFiles.map(
                                          (file, index) => (
                                            <p
                                              key={index}
                                ...
                                <div className="mt-2">
                                  <Textarea
                                    placeholder={
                                      language === "am"
                                        ? "የቁሳቁስ ሊንኮችን በአዲስ መስመር ያስገቡ..."
                                        : "Enter material links, one per line..."
                                    }
                                    value={
                                      courseForm.materialsLinks
                                        ? courseForm.materialsLinks.join("\n")
                                        : ""
                                    }
                                    onChange={(e) =>
                                      setCourseForm({
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span className="text-lg lg:text-xl">
                      {language === "am" ? "ይዘት አስተዳድር" : "Content Management"}
                    </span>
                  </CardTitle>
                  <div className="flex flex-col sm:flex-row gap-4 mt-4">
                    ...
                    >
                      <option value="all">
                        {language === "am" ? "ሁሉም" : "All Content"}
                      </option>
                      <option value="posts">
                        {language === "am" ? "ስብከቶች" : "Posts"}
                      </option>
                      <option value="podcasts">
                        {language === "am" ? "ፖድካስቶች" : "Podcasts"}
                      </option>
                      <option value="courses">
                        {language === "am" ? "ኰርሶች" : "Courses"}
                      </option>
                    </select>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {filteredContent().map((item) => (
                      <div
                        key={item.id}
                        className="flex flex-col lg:flex-row lg:items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors space-y-4 lg:space-y-0"
                      >
                        <div className="flex-1 min-w-0">
                  ...
                  <div className="space-y-4">
                    {prayerRequests.length === 0 ? (
                      ...
                      prayerRequests.map((request) => (
                        <div
                          key={request.id}
                          className="p-4 lg:p-6 border rounded-lg bg-gradient-to-r from-purple-50 to-blue-50"
                        >
                          <div className="flex flex-col lg:flex-row lg:items-start justify-between space-y-4 lg:space-y-0">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                ...
                                variant="destructive"
                                onClick={() =>
                                  deleteContent(request.id, "prayer")
                                }
                              >
                                <Trash2 className="h-3 w-3" />
                              </Button>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div>
                        <div className="flex justify-between text-sm mb-2">
                          <span>
                            {language === "am" ? "ሳምንታዊ እይታዎች" : "Weekly Views"}
                          </span>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {Math.floor(analytics.totalViews * 0.7)}{" "}
                          {language === "am" ? "ይህ ሳምንት" : "this week"}
                        </p>
                      </div>
                      ...
                      <div>
                        <div className="flex justify-between text-sm mb-2">
                          <span>
                            {language === "am" ? "ተሳትፎ ደረጃ" : "Engagement Rate"}
                          </span>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {language === "am" ? "በተመሳሳይ ሁኔታ" : "Above average"}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {Math.floor(analytics.activeUsers * 0.68)}{" "}
                          {language === "am" ? "ተመልሰው መጥተዋል" : "users returned"}
                        </p>
                      </div>
                    </div>
                  </CardContent>
